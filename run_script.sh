...
python tests/test_algorithms/unified_benchmark.py --compare --algorithms nn-qnehvi --problem complex_categorical --budget 100 --batch-size 10 --output-dir output/nn_complex_categorical_no_sin